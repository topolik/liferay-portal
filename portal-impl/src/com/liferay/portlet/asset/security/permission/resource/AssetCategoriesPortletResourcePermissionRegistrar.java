 ...
 */
public class AssetCategoriesPortletResourcePermissionRegistrar {
	...
	public void afterPropertiesSet() {
		...
		properties.put(
			"resource.name", AssetConstants.RESOURCE_NAME_CATEGORIES);

		_serviceRegistration = registry.registerService(
			PortletResourcePermission.class,
			PortletResourcePermissionFactory.create(
				AssetConstants.RESOURCE_NAME_CATEGORIES,
				new AssetCategoriesStagedPortletPermissionLogic()),
			properties);
	}
	...
	private static final String _ASSET_CATEGORIES_ADMIN_PORTLET =
	...
	private class AssetCategoriesStagedPortletPermissionLogic
		...
		public Boolean contains(
			...
			return stagingPermission.hasPermission(
				...
				_ASSET_CATEGORIES_ADMIN_PORTLET, actionId);
		}
