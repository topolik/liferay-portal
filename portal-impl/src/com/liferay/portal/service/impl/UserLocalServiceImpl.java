...
public class UserLocalServiceImpl extends UserLocalServiceBaseImpl {
	 ...
	 * @return the new user
	 * @deprecated As of 7.0.0, replaced by {@link #addUser(long, long, boolean,
	 *         String, String, boolean, String, String, long, String, String, Locale,
	 *         String, String, String, long, long, boolean, int, int, int, String, long[],
	 *         long[], long[], long[], boolean, ServiceContext)}
	...
	public User addUser(
		...
		return addUser(
			creatorUserId, companyId, autoPassword, password1, password2,
			autoScreenName, screenName, emailAddress, facebookId, openId,
			StringPool.BLANK, locale, firstName, middleName, lastName, prefixId,
			suffixId, male, birthdayMonth, birthdayDay, birthdayYear, jobTitle,
			groupIds, organizationIds, roleIds, userGroupIds, sendEmail,
			serviceContext);
	}
	 ...
	 *         bridge attributes for the user.
	 * @return the new user
	 * @deprecated As of 7.0.0, replaced by {@link #addUserWithWorkflow(long, long, boolean,
	 *         String, String, boolean, String, String, long, String, String, Locale,
	 *         String, String, String, long, long, boolean, int, int, int, String, long[],
	 *         long[], long[], long[], boolean, ServiceContext)}
	 */
