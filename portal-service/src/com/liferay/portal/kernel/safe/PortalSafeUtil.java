...
public class PortalSafeUtil {
	 ...
	 *
	 * <p>
	 * The method tries to get company's groupId using
	 * {@link #getCompanyGroupId(long)} and continues calling
	 * {@link #listItemsNames(long, long)}.
	 * </p>
	 *
	 ...
	 * The method tries to get company's groupId using
	 * {@link #getCompanyGroupId(long)} and continues calling
	 * {@link #loadItem(long, long, String)}.
	 * </p>
	 *
	 ...
	 * the item's name. The method uses wrapped instance to delegate the call
	 * to.
	 *
	 * @param companyId id of company to load items from
	 ...
	 * The method tries to get company's groupId using
	 * {@link #getCompanyGroupId(long)} and continues calling
	 * {@link #removeItem(long, long, String)}.
	 * </p>
	 *
	 ...
	 * the groupId and the item's name. The method uses wrapped instance to
	 ...
	 * The method tries to get company's groupId using
	 * {@link #getCompanyGroupId(long)} and continues calling
	 * {@link #saveItem(long, long, com.liferay.portal.kernel.safe.model.Item)}.
	 * </p>
	 *
	...
	/**
	 * Stores the item into safe.The method uses wrapped instance to
	 * delegate the call to.
	 *
	 * @param companyId id of company to save the item to
