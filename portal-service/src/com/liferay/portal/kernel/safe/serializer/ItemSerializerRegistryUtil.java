...
public class ItemSerializerRegistryUtil {
	...
	/**
	 * Delegates call to the wrapped service to remove the serializer from
	 * the registry.
	 *
	 * @param serializer the item serializer to be removed
	 * @return <code>true</code> when serializer was found and removed
	 *         from the registry, <code>false</code> otherwise
	 */
