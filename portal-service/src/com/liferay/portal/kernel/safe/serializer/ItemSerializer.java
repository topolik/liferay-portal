...
/**
 * Converts instance of {@link Item} into its binary form -
...
public interface ItemSerializer<T extends Item> {
	 ...
	 * for deserialization of {@link SerializedItem} using
	 * {@link #read(SerializedItem)} method.
	 *
	...
	/**
	 * Convert SerializedItem into new instance of {@link Item} using
	 * {@link SerializedItem#getItemStream()}.
	 *
	 * <p>
	 * Implementation MUST copy companyId and groupId from the item into
	 * the result. Serializer may use {@link SerializedItem#getHeader()}
	 * to read item's metadata that was previously stored by the
	 * {@link #read(SerializedItem)} method.
	 * </p>
	 *
	 ...
	 * stores in result using
	 * {@link SerializedItem#setItemStream(java.io.InputStream)}.
	 *
	 * <p>
	 * Implementation MUST copy companyId and groupId from the item into
	 * the result. Serializer may use
	 * {@link SerializedItem#setHeader(byte[])} to store any metadata.
	 * The header will be then available in the
	 * {@link #read(SerializedItem)} method.
	 * </p>
	 *
