...
/**
 * Stores {@link ItemSerializer}s and use them for storing and loading
 * {@link Item}s in their serialized form {@link SerializedItem}.
 *
...
public interface ItemSerializerRegistry {
	 ...
	 * @throws NoSuchItemSerializerException if no suitable serializer is
	 *         found to parse the serializedItem
	 */
	 ...
	 * @exception DuplicateItemSerializerException if there is already
	 *            registered a serializer with the same
	 *            {@link ItemSerializer#getSerializerUID()} or
	 *            {@link ItemSerializer#getSupportedClass()}}
	 */
	public void registerSerializer(ItemSerializer serializer)
		throws DuplicateItemSerializerException;

	/**
	 * Tries to convert the item into returned {@link SerializedItem} using
	 * one of registered serializers.
	 *
	 * <p>
