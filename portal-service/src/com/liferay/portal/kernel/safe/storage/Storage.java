 ...
 * </li>
 * <li>
 * the key is strong enough to endure offline attack in case of the data leak
 * </li>
 * <li>
 * the key and the encrypted data are separated, so that an attacker must gain
 * access to multiple locations to be able to decrypt the data
 * </li>
 * </ul>
 * </p>
 *
