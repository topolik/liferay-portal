...
public class DeviceLocalServiceUtil {
	...
	*/
	...
	static {
		Bundle bundle = FrameworkUtil.getBundle(DeviceLocalService.class);

		ServiceTracker<DeviceLocalService, DeviceLocalService> serviceTracker = new ServiceTracker<DeviceLocalService, DeviceLocalService>(bundle.getBundleContext(),
				DeviceLocalService.class, null);
