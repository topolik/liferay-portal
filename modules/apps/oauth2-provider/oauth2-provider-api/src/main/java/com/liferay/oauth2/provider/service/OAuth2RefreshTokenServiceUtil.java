...
/**
 * Provides the remote service utility for OAuth2RefreshToken. This utility wraps
 * {@link com.liferay.oauth2.provider.service.impl.OAuth2RefreshTokenServiceImpl} and is the
 ...
 */
@ProviderType
public class OAuth2RefreshTokenServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	...
	public static OAuth2RefreshTokenService getService() {
		return _serviceTracker.getService();
	}

	private static ServiceTracker<OAuth2RefreshTokenService, OAuth2RefreshTokenService> _serviceTracker =
		ServiceTrackerFactory.open(OAuth2RefreshTokenService.class);
}