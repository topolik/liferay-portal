 ...
 */
public class TestServiceAccessQuotaMetricConfigImpl implements SAQMetricConfig {

	public TestServiceAccessQuotaMetricConfigImpl(String name, String pattern) {
		_name = name;
		_pattern = pattern;
	}
