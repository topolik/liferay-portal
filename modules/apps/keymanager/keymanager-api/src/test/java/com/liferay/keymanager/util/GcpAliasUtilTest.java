...
public class GcpAliasUtilTest {
	...
	public void testChaosAliasNormalization() {
		...
		// 2. Multiple hyphens (should not collapse them, just preserve or replace based on logic)
		Assert.assertEquals(
			"my---secret---key___",
		...
		Assert.assertEquals("NormalString123", GcpAliasUtil.normalize("NormalString123"));
	}
