...
@Meta.OCD(
	id = "com.liferay.keymanager.provider.gcp.internal.configuration.GcpServiceAccountKeyAccessTokenSecretVaultProviderConfiguration",
	localization = "content/Language",
	name = "gcp-service-account-key-access-token-secret-vault-provider-configuration-name"
)
public interface
