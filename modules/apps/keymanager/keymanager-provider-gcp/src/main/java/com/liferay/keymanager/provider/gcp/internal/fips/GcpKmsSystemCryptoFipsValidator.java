...
public class GcpKmsSystemCryptoFipsValidator extends BaseGcpFipsValidator {

	@Override
	public String getConfigurationPid() {
		return "com.liferay.keymanager.provider.gcp.internal.configuration.GcpKmsSystemCryptoVaultProviderConfiguration";
	}
