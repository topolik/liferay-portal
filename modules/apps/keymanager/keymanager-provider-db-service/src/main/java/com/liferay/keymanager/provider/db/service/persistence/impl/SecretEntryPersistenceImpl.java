...
public class SecretEntryPersistenceImpl
	 ...
	 */
	@Override
	public List<SecretEntry> findByCompanyId(long companyId) {
	 ...
	 */
	@Override
	public List<SecretEntry> findByCompanyId(
	...
	public List<SecretEntry> findByCompanyId(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (SecretEntry secretEntry : list) {
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				sb.append(SecretEntryModelImpl.ORDER_BY_JPQL);
			}
	...
	public SecretEntry findByCompanyId_First(
		...
		SecretEntry secretEntry = fetchByCompanyId_First(
	...
	public SecretEntry fetchByCompanyId_First(
		...
		List<SecretEntry> list = findByCompanyId(
	...
	public SecretEntry findByCompanyId_Last(
		...
		SecretEntry secretEntry = fetchByCompanyId_Last(
			companyId, orderByComparator);
	...
	public SecretEntry[] findByCompanyId_PrevAndNext(
		...
		SecretEntry secretEntry = findByPrimaryKey(secretEntryId);
		...
		try {
			...
			SecretEntry[] array = new SecretEntryImpl[3];

			array[0] = getByCompanyId_PrevAndNext(
				session, secretEntry, companyId, orderByComparator, true);

			array[1] = secretEntry;

			array[2] = getByCompanyId_PrevAndNext(
				session, secretEntry, companyId, orderByComparator, false);
	...
	protected SecretEntry getByCompanyId_PrevAndNext(
		Session session, SecretEntry secretEntry, long companyId,
		OrderByComparator<SecretEntry> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(secretEntry)) {
	...
	public int countByCompanyId(long companyId) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_SECRETENTRY_WHERE);
