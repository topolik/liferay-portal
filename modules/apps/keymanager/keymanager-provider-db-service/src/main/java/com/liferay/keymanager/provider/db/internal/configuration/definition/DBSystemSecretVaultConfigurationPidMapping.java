...
public class DBSystemSecretVaultConfigurationPidMapping
	extends BaseDBConfigurationPidMapping {

	public DBSystemSecretVaultConfigurationPidMapping() {
		super(
			DBSystemSecretVaultProviderConfiguration.class,
			DBSystemSecretVaultProviderConfiguration.class.getName());
	}
