...
@ExtendedObjectClassDefinition(
	category = "keymanager", scope = ExtendedObjectClassDefinition.Scope.COMPANY
)
@Meta.OCD(
	id = "com.liferay.keymanager.provider.db.internal.configuration.DBCompanySecretVaultProviderConfiguration",
	localization = "content/Language",
	name = "db-company-secret-vault-provider-configuration-name"
)
public interface DBCompanySecretVaultProviderConfiguration {
