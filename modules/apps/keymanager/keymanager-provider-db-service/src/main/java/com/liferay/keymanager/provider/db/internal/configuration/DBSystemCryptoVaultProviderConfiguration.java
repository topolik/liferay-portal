...
@Meta.OCD(
	id = "com.liferay.keymanager.provider.db.internal.configuration.DBSystemCryptoVaultProviderConfiguration",
	localization = "content/Language",
	name = "db-system-crypto-vault-provider-configuration-name"
)
public interface DBSystemCryptoVaultProviderConfiguration {
	...
	@Meta.AD(
		deflt = "db-system", description = "db-crypto-provider-id-description",
