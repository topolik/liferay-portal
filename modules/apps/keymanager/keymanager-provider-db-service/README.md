...
1.  **Scaffolding**: Uses `ConfigurationPidMapping` to appear in the "Virtual Instance" settings.

1.  **Finders**: Uses a composite `C_A` (Company and Alias) finder for all database lookups.
