...
<aui:form action="<%= configurationActionURL %>" method="post" name="fm">
	...
	<aui:fieldset>
		<aui:input cssClass="lfr-input-text-container" name="preferences--xmlUrl--" type="text" value="" />

		<aui:input cssClass="lfr-input-text-container" name="preferences--xslUrl--" type="text" value="" />
	</aui:fieldset>
