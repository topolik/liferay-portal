...
public class EditCASConfigurationMVCActionCommand extends BaseMVCActionCommand implements MVCActionCommand {
	...
	protected void validateCAS(ActionRequest actionRequest) {
		...
		boolean importFromLDAP = ParamUtil.getBoolean(actionRequest, "cas--" + CASConstants.CAS_IMPORT_FROM_LDAP + "--");
		String casLoginURL = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_LOGIN_URL + "--");
		String casLogoutURL = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_LOGOUT_URL + "--");
		String casServerName = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_SERVER_NAME + "--");
		String casServerURL = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_SERVER_URL + "--");
		String casServiceURL = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_SERVICE_URL + "--");
		String casNoSuchUserRedirectURL = ParamUtil.getString(actionRequest, "cas--" + CASConstants.CAS_NO_SUCH_USER_REDIRECT_URL + "--");
