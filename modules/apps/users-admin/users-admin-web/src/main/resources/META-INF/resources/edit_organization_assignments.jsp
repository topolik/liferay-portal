...
<aui:form action="<%= portletURL.toString() %>" method="post" name="fm">
	...
	>
		...
		else if (PropsValues.ORGANIZATIONS_ASSIGNMENT_STRICT && !permissionChecker.isCompanyAdmin() && !permissionChecker.hasPermission(scopeGroupId, User.class.getName(), ActionKeys.VIEW)) {
