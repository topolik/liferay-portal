 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.multi.factor.authentication.provider.email.otp.service.impl.EmailOTPEntryLocalServiceImpl}.
 * </p>
 *
 * @author arthurchan35
 * @see com.liferay.multi.factor.authentication.provider.email.otp.service.impl.EmailOTPEntryLocalServiceImpl
 * @generated
 */
@ProviderType
public abstract class EmailOTPEntryLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements EmailOTPEntryLocalService, AopService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>EmailOTPEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>com.liferay.multi.factor.authentication.provider.email.otp.service.EmailOTPEntryLocalServiceUtil</code>.
	 */
