...
import com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTPEntryModel;
...
/**
 * The base model implementation for the EmailOTPEntry service. Represents a row in the &quot;EmailOTPEntry&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class EmailOTPEntryModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "EmailOTPEntry";
	...
	static {
		...
		attributeGetterFunctions.put(
			"emailAddress", EmailOTPEntry::getEmailAddress);
		attributeSetterBiConsumers.put(
			"emailAddress",
			(BiConsumer<EmailOTPEntry, String>)EmailOTPEntry::setEmailAddress);
		attributeGetterFunctions.put(
	...
	public EmailOTPEntry toEscapedModel() {
		if (_escapedModel == null) {
			_escapedModel = (EmailOTPEntry)ProxyUtil.newProxyInstance(
	...
	public Object clone() {
		...
		emailOTPEntryImpl.setEmailAddress(getEmailAddress());
	...
	public CacheModel<EmailOTPEntry> toCacheModel() {
		...
		emailOTPEntryCacheModel.emailAddress = getEmailAddress();

		String emailAddress = emailOTPEntryCacheModel.emailAddress;

		if ((emailAddress != null) && (emailAddress.length() == 0)) {
			emailOTPEntryCacheModel.emailAddress = null;
		}
	...
	private static final ClassLoader _classLoader =
		EmailOTPEntry.class.getClassLoader();
	private static final Class<?>[] _escapedModelInterfaces = new Class[] {
		EmailOTPEntry.class, ModelWrapper.class
	};
