...
/**
 * Provides the local service interface for OTPEmail. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author arthurchan35
 * @see OTPEmailLocalServiceUtil
...
public interface OTPEmailLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link OTPEmailLocalServiceUtil} to access the otp email local service. Add custom service methods to {@link com.liferay.multi.factor.authentication.provider.otp.service.impl.OTPEmailLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public OTPEmail addOTPEmail(OTPEmail otpEmail);
	...
	*/
	...
	public OTPEmail createOTPEmail(long otpEmailId);
	...
	*/
	...
	public OTPEmail deleteOTPEmail(long otpEmailId) throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public OTPEmail deleteOTPEmail(OTPEmail otpEmail);
	...
	*/
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OTPEmail fetchOTPEmail(long otpEmailId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public OTPEmail getOTPEmail(long otpEmailId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<OTPEmail> getOTPEmails(int start, int end);
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public OTPEmail updateOTPEmail(OTPEmail otpEmail);
}