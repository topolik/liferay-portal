 ...
 * {@link com.liferay.multi.factor.authentication.provider.email.otp.service.impl.EmailOTPLocalServiceImpl} and is the
 ...
 * @see com.liferay.multi.factor.authentication.provider.email.otp.service.base.EmailOTPLocalServiceBaseImpl
...
public class EmailOTPLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.liferay.multi.factor.authentication.provider.email.otp.service.impl.EmailOTPLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP addEmailOTP(
	...
	*/
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP createEmailOTP(
		long emailOTPId) {
	...
	*/
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP deleteEmailOTP(
		com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP emailOTP) {
	...
	*/
	...
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP deleteEmailOTPByUserId(
	...
	*/
	...
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP fetchEmailOTP(
		long emailOTPId) {
		return getService().fetchEmailOTP(emailOTPId);
	}

	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP fetchEmailOTPByUserId(
		long userId) {
	...
	* @throws PortalException if a email otp with the primary key could not be found
	*/
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP getEmailOTP(
		long emailOTPId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static java.util.List<com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP> getEmailOTPs(
		int start, int end) {
	...
	*/
	...
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP updateAttempts(
	...
	*/
	public static com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP updateEmailOTP(
		com.liferay.multi.factor.authentication.provider.email.otp.model.EmailOTP emailOTP) {
	...
	private static ServiceTracker<EmailOTPLocalService, EmailOTPLocalService> _serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EmailOTPLocalService.class);

		ServiceTracker<EmailOTPLocalService, EmailOTPLocalService> serviceTracker =
			new ServiceTracker<EmailOTPLocalService, EmailOTPLocalService>(bundle.getBundleContext(),
				EmailOTPLocalService.class, null);
