 ...
 */
@ProviderType
public class EmailOTPLocalServiceWrapper
	implements EmailOTPLocalService, ServiceWrapper<EmailOTPLocalService> {
	...
	public long dynamicQueryCount(
		...
		return _emailOTPLocalService.dynamicQueryCount(
