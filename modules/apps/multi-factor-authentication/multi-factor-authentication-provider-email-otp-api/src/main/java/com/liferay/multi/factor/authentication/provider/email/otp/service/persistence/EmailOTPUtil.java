...
/**
 * The persistence utility for the email otp service. This utility wraps <code>com.liferay.multi.factor.authentication.provider.email.otp.service.persistence.impl.EmailOTPPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class EmailOTPUtil {
	 ...
	 */
	public static EmailOTP update(
		EmailOTP emailOTP, ServiceContext serviceContext) {
	...
	public static EmailOTP findByUserId(long userId)
		throws com.liferay.multi.factor.authentication.provider.email.otp.
			exception.NoSuchEmailOTPException {
	 ...
	 * @return the matching email otp, or <code>null</code> if a matching email otp could not be found
	 */
	public static EmailOTP fetchByUserId(
	...
	private static ServiceTracker<EmailOTPPersistence, EmailOTPPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(EmailOTPPersistence.class);

		ServiceTracker<EmailOTPPersistence, EmailOTPPersistence>
			serviceTracker =
				new ServiceTracker<EmailOTPPersistence, EmailOTPPersistence>(
					bundle.getBundleContext(), EmailOTPPersistence.class, null);
