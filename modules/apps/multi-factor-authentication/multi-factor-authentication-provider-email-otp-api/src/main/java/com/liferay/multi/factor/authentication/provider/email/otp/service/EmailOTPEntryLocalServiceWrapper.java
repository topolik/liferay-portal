...
public class EmailOTPEntryLocalServiceWrapper
	 ...
	 */
	@Override
	public com.liferay.multi.factor.authentication.provider.email.otp.model.
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>EmailOTPEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>EmailOTPEntryEntryLocalServiceUtil</code>.
	 */
	@Override
	public com.liferay.multi.factor.authentication.provider.email.otp.model.
		...
		return _emailOTPEntryLocalService.addEntry(userId, email, ip);
	}
	...
	public com.liferay.multi.factor.authentication.provider.email.otp.model.
		...
		return _emailOTPEntryLocalService.deleteEntryByUserId(userId);
	}
	...
	@Override
	public com.liferay.multi.factor.authentication.provider.email.otp.model.
		EmailOTPEntry updateAttempts(long userId, boolean success, String ip)
			throws com.liferay.portal.kernel.exception.PortalException {

		return _emailOTPEntryLocalService.updateAttempts(userId, success, ip);
	}
