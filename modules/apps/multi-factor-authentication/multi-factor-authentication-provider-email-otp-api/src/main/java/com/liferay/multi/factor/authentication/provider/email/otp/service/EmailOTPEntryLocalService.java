...
/**
 * Provides the local service interface for EmailOTPEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author arthurchan35
 * @see EmailOTPEntryLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EmailOTPEntryLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EmailOTPEntryLocalServiceUtil} to access the email otp entry local service. Add custom service methods to <code>com.liferay.multi.factor.authentication.provider.email.otp.service.impl.EmailOTPEntryLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
