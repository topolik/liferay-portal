...
import com.liferay.multi.factor.authentication.otp.model.impl.TOTPImpl;
import com.liferay.multi.factor.authentication.otp.model.impl.TOTPModelImpl;
 ...
 * @author arthurchan35
 * @see TOTPPersistence
 * @see com.liferay.multi.factor.authentication.otp.service.persistence.TOTPUtil
 * @generated
 */
@ProviderType
public class TOTPPersistenceImpl extends BasePersistenceImpl<TOTP>
	...
	public static final String FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION = FINDER_CLASS_NAME_ENTITY +
		".List2";
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_ALL = new FinderPath(TOTPModelImpl.ENTITY_CACHE_ENABLED,
			TOTPModelImpl.FINDER_CACHE_ENABLED, TOTPImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_ALL = new FinderPath(TOTPModelImpl.ENTITY_CACHE_ENABLED,
			TOTPModelImpl.FINDER_CACHE_ENABLED, TOTPImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findAll", new String[0]);
	public static final FinderPath FINDER_PATH_COUNT_ALL = new FinderPath(TOTPModelImpl.ENTITY_CACHE_ENABLED,
			TOTPModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countAll", new String[0]);
	public static final FinderPath FINDER_PATH_FETCH_BY_USERID = new FinderPath(TOTPModelImpl.ENTITY_CACHE_ENABLED,
			TOTPModelImpl.FINDER_CACHE_ENABLED, TOTPImpl.class,
			FINDER_CLASS_NAME_ENTITY, "fetchByUserId",
			new String[] { Long.class.getName() },
			TOTPModelImpl.USERID_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERID = new FinderPath(TOTPModelImpl.ENTITY_CACHE_ENABLED,
			TOTPModelImpl.FINDER_CACHE_ENABLED, Long.class,
	...
	protected void cacheUniqueFindersCache(TOTPModelImpl totpModelImpl) {
		...
		finderCache.putResult(FINDER_PATH_FETCH_BY_USERID, args, totpModelImpl,
			false);
	}
