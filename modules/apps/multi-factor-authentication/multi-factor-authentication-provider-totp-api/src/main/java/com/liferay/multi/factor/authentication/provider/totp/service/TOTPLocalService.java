...
/**
 * Provides the local service interface for TOTP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author arthurchan35
 * @see TOTPLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TOTPLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TOTPLocalServiceUtil} to access the totp local service. Add custom service methods to <code>com.liferay.multi.factor.authentication.provider.totp.service.impl.TOTPLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>TOTPLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>TOTPLocalServiceUtil</code>.
	 */
	...
	public TOTP createTOTP(long totpId);
	...
	public TOTP deleteTOTP(long totpId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public TOTP deleteTOTP(TOTP totp);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TOTP fetchTOTP(long totpId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TOTP getTOTP(long totpId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TOTP> getTOTPs(int start, int end);
