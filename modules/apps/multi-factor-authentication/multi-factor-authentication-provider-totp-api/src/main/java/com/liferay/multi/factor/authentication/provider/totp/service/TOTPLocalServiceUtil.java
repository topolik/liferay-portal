 ...
 * <code>com.liferay.multi.factor.authentication.provider.totp.service.impl.TOTPLocalServiceImpl</code> and
...
public class TOTPLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.multi.factor.authentication.provider.totp.service.impl.TOTPLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */

	/**
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. Use <code>TOTPLocalService</code> via injection or a <code>ServiceTracker</code> or use <code>TOTPLocalServiceUtil</code>.
	 */
	public static
		com.liferay.multi.factor.authentication.provider.totp.model.TOTP
				addTOTP(long userId, String sharedSecret)
	...
	public static
		com.liferay.multi.factor.authentication.provider.totp.model.TOTP
				updateVerified(long totpId, boolean verified)
			throws com.liferay.portal.kernel.exception.PortalException {
	...
	private static ServiceTracker<TOTPLocalService, TOTPLocalService>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TOTPLocalService.class);

		ServiceTracker<TOTPLocalService, TOTPLocalService> serviceTracker =
			new ServiceTracker<TOTPLocalService, TOTPLocalService>(
				bundle.getBundleContext(), TOTPLocalService.class, null);
