...
/**
 * The persistence utility for the totp service. This utility wraps <code>com.liferay.multi.factor.authentication.provider.totp.service.persistence.impl.TOTPPersistenceImpl</code> and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
...
public class TOTPUtil {
	 ...
	 */
	public static List<TOTP> findWithDynamicQuery(
	...
	public static TOTP findByUserId(long userId)
		throws com.liferay.multi.factor.authentication.provider.totp.exception.
			NoSuchTOTPException {
	...
	private static ServiceTracker<TOTPPersistence, TOTPPersistence>
		_serviceTracker;

	static {
		Bundle bundle = FrameworkUtil.getBundle(TOTPPersistence.class);

		ServiceTracker<TOTPPersistence, TOTPPersistence> serviceTracker =
			new ServiceTracker<TOTPPersistence, TOTPPersistence>(
				bundle.getBundleContext(), TOTPPersistence.class, null);
