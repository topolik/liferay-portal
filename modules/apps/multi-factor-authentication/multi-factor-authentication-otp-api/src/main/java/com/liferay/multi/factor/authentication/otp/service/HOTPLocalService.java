...
/**
 * Provides the local service interface for HOTP. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author arthurchan35
 * @see HOTPLocalServiceUtil
...
public interface HOTPLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link HOTPLocalServiceUtil} to access the hotp local service. Add custom service methods to {@link com.liferay.multi.factor.authentication.otp.service.impl.HOTPLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
