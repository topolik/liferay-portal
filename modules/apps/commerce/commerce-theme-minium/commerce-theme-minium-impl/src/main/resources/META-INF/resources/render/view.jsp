		...
		<div class="col-md-6 col-xs-12">
			...
			<c:choose>
				<c:when test="<%= cpSku != null %>">
					<div class="availability mt-1"><%= HtmlUtil.escape(cpContentHelper.getAvailabilityLabel(request)) %></div>
					<div class="availability-estimate mt-1"><%= HtmlUtil.escape(cpContentHelper.getAvailabilityEstimateLabel(request)) %></div>
					<div class="mt-1 stock-quantity"><%= HtmlUtil.escape(cpContentHelper.getStockQuantityLabel(request)) %></div>
				</c:when>
				<c:otherwise>
