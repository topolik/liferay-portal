		...
		<aui:fieldset>
			...
			<aui:select label="option-field-type" name="DDMFormFieldTypeName" showEmptyOption="<%= true %>">
				...
				%>
					...
					<aui:option label="<%= HtmlUtil.escape(cpOptionDisplayContext.getDDMFormFieldTypeLabel(ddmFormFieldType, locale)) %>" selected="<%= (cpOption != null) && cpOption.getDDMFormFieldTypeName().equals(ddmFormFieldType.getName()) %>" value="<%= HtmlUtil.escape(ddmFormFieldType.getName()) %>" />
