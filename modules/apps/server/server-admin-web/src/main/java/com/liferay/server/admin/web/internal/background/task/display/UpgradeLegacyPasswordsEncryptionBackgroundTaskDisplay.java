...
package com.liferay.server.admin.web.internal.background.task.display;
 ...
 * @author arthurchan35
 */
public class UpgradeLegacyPasswordsEncryptionBackgroundTaskDisplay
	extends BaseBackgroundTaskDisplay {

	public UpgradeLegacyPasswordsEncryptionBackgroundTaskDisplay(
	...
	private static final String _PROGRESS_TEMPLATE =
		"com/liferay/server/admin/web/internal/background/task/display" +
			"/dependencies/upgrade_legacy_passwords_encryption_background_" +
				"task_progress.ftl";
