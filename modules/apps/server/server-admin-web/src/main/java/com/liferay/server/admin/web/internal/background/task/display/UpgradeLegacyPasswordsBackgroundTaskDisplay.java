 ...
 * @author arthurchan35
 */
public class UpgradeLegacyPasswordsBackgroundTaskDisplay
	extends BaseBackgroundTaskDisplay {

	public UpgradeLegacyPasswordsBackgroundTaskDisplay(
	...
	private static final String _PROGRESS_TEMPLATE =
		"com/liferay/server/admin/web/internal/background/task/display" +
			"/dependencies/upgrade_legacy_passwords_background_" +
				"task_progress.ftl";
