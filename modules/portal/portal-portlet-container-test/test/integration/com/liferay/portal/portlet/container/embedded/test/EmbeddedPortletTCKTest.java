...
public class EmbeddedPortletTCKTest {
	...
	public static class WhenEmbeddingNonEmbeddablePortletInLayout {
		...
		public void setUp() throws Exception {
			...
			_registerPortlet(_nonEmbeddedPortlet);
		}
		...
		public void shouldReturnItsConfiguration() throws Exception {
			...
			List<PortletPreferences> portletPreferences =
				PortletPreferencesLocalServiceUtil.getPortletPreferences(
					_layout.getPlid(), _nonEmbeddedPortlet.getPortletId());
		...
		private void _registerPortlet(Portlet portlet) throws Exception {
			Bundle bundle = FrameworkUtil.getBundle(
				WhenEmbeddingNonEmbeddablePortletInLayout.class);
