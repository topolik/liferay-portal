...
public class PortalSettingsOpenSSOAuthenticationFormMVCActionCommand
	...
	protected void doProcessAction(
		...
		Settings settings = SettingsFactoryUtil.getSettings(
			new CompanyServiceSettingsLocator(
				themeDisplay.getCompanyId(), OpenSSOConstants.SERVICE_NAME));
