...
package com.liferay.portal.security.sso.openid.portal.settings.web.servlet.taglib;
 ...
 */
@Component(
	immediate = true, property = {"portal.settings.authentication.tabs.name=open-id"},
...
public class PortalSettingsOpenIdAuthenticationDynamicInclude
	...
	private static final String _JSP_PATH = "/portal-settings/open_id.jsp";
